  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Stack(children: [
            ...
            child: Column(children: [
              ...
              Column(children: [
                Stack(children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                      ...
                      color: activeFrame == 'none' ? context.subtleBg
                ...
                if (_editName)
                  ...
                  Row(mainAxisSize: MainAxisSize.min, children: [
                    Text('${userData.name.split(' ').first} 님', style: TextStyle(fontSize: 16, fontWeight: FontWeight.w600, color: context.textPrimary)),
              ...
              Padding(
                ...
                child: GestureDetector(
                  onTap: () => Navigator.push(context, SlideRightRoute(page: const FocusStatsScreen())),
                  child: Container(
                    ...
                    child: Row(children: [
                      ...
                      Expanded(child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
                        ...
                        Text('누적 ${focusHours}시간 · ${userData.totalFocusMin % 60}분 집중', style: TextStyle(fontSize: 12, color: context.textSecondary)),
                      ])),
                      ...
                      child: AnimatedContainer(
                        ...
                        child: Opacity(
                          ...
                          child: Column(mainAxisAlignment: MainAxisAlignment.center, children: [
                            ...
                            if (!unlocked)
                              Text('Lv.${item['lv']}', style: TextStyle(fontSize: 10, color: context.textSecondary))
                            else if (isActive)
                              Text('착용 중', style: TextStyle(fontSize: 10, color: context.isDark ? Colors.black54 : Colors.white70)),
                          ]),
                        ),
                      ),
                    );
        ...
        if (_shopModal) _ShopModal(onClose: () => setState(() => _shopModal = false)),
      ]),
    );
  }
          ...
          child: GestureDetector(
            ...
            child: Container(
              ...
              child: Column(mainAxisSize: MainAxisSize.min, crossAxisAlignment: CrossAxisAlignment.start, children: [
                Text('🛡️ 부활 아이템 구매', style: TextStyle(fontSize: 18, fontWeight: FontWeight.w600, color: context.textPrimary)),
                const SizedBox(height: 6),
                Text('스트릭이 끊겼을 때 1회 복구할 수 있는 아이템입니다.', style: TextStyle(fontSize: 13, color: context.textSecondary, height: 1.6)),
                const SizedBox(height: 20),
                ...[
                  ...
                  child: Container(
                    ...
                    decoration: BoxDecoration(
                      color: item['highlight'] == true ? context.primaryColor : context.surfaceColor,
                      borderRadius: BorderRadius.circular(14),
                      border: Border.all(color: item['highlight'] == true ? context.primaryColor : context.borderColor),
                    ),
                    child: Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
                      Row(children: [
                        Text('🛡️ × ${item['count']}', style: TextStyle(fontSize: 20,
                            color: item['highlight'] == true ? (context.isDark ? Colors.black : Colors.white) : context.textPrimary)),
                        const SizedBox(width: 10),
                        Text(item['label'] as String, style: TextStyle(fontSize: 12,
                            color: item['highlight'] == true ? (context.isDark ? Colors.black54 : Colors.white70) : context.textSecondary)),
                      ]),
                ...
                Text('결제는 앱스토어 정책에 따라 처리됩니다.\n구매한 아이템은 환불되지 않습니다.',
                    textAlign: TextAlign.center, style: TextStyle(fontSize: 11, color: context.textSecondary, height: 1.6)),
              ]),
            ),
          ),
        ),
